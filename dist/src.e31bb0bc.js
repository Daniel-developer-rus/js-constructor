...
exports.Columns = exports.Image = exports.Header = void 0;
...
var Header = /*#__PURE__*/function (_Block) {
  ...
  _createClass(Header, [{
    ...
    value: function toHTML() {
      ...
      var _ref = (_this$options = this.options) !== null && _this$options !== void 0 ? _this$options : 'h1',
          styles = _ref.styles;
...
var model = [new _blocks.Header('Конструктор сайтов на чистом JS', {
  tag: 'h2',
  styles: {
...
}), new _blocks.Image(_image.default, {
  styles: {
    display: 'flex',
    padding: '2rem 0',
...
}), new _blocks.Columns(['Приложение на чистом JS, без использования библиотек', 'С ипользованием принципы SOLID и ООП', 'javaScript -  это просто, интересно для создания любых UI своими руками'], {
  styles: {
...
var Sidebar = /*#__PURE__*/function () {
  ...
  _createClass(Sidebar, [{
    ...
    value: function add(event) {
      ...
      var newBlock = type === 'title' && new _blocks.Header(value, {
        styles: styles
      });
...
var App = /*#__PURE__*/function () {
  ...
  _createClass(App, [{
    ...
    value: function init() {
      ...
      var updateCallback = function updateCallback(block) {
        _this.model.push(block);
...
exports.App = App;
},{"./site":"classes/site.js","./sidebar":"classes/sidebar.js"}],"../../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
},{"./model":"model.js","./classes/app":"classes/app.js","./main.css":"main.css"}],"../../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
